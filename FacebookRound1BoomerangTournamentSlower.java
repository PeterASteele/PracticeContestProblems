...
//Another previous revision of Boomerang, without implementing the mapping. Still works well within 6 minutes, but is closer in the worst case.
public class FacebookRound1BoomerangTournamentSlower {
		...
		for (int testcase = 0; testcase < numberOfTestCases; testcase++) {
			...
			for (int a = 2; a < n; a = a * 2) {
				...
				for (BitSet storage : afterRound) {
					...
					GameTree tempGame = getAllGames(storage);
